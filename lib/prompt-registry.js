...
const PROMPT_DEFAULTS = [
  {
    ...
    systemPrompt: "You are an elite crypto trading analyst with live data access. Think step-by-step privately. Output must be strict JSON only (single object, no markdown, no prose, no code fences).",
    userPromptTemplate: [
  ...
  },
  {
    ...
    systemPrompt: "You are an expert crypto analyst building educational demo trades. Think through the data silently. Output must be strict JSON only (single object, no markdown, no prose, no code fences).",
    userPromptTemplate: [
